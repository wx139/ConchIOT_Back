...
class DeviceParams(models.Model):
    ...
    fz_01 = models.CharField(max_length=32, verbose_name='定时1开时间',null=True,blank=True)
    fz_02 = models.CharField(max_length=32, verbose_name='定时1开时间',null=True,blank=True)
    ...
    ddydz = models.CharField(max_length=32, verbose_name='定时1开时间',null=True,blank=True)
    gdydz = models.CharField(max_length=32, verbose_name='定时1开时间',null=True,blank=True)
